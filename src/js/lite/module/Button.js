  ...
  var Button = function (context) {
    ...
    this.addToolbarButtons = function () {
      context.addButton('style', function () {
        return ui.buttonGroup([
          ui.button({
            ...
            contents: '<i class="fa fa-magic"/> <span class="fa fa-caret-down"/>',
      ...
      context.addButton('fontname', function () {
        return ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: '<span class="note-current-fontname"/> <span class="fa fa-caret-down"/>',
      ...
      context.addButton('fontsize', function () {
        return ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: '<span class="note-current-fontsize"/> <span class="fa fa-caret-down"/>',
      ...
      context.addButton('color', function () {
        return ui.buttonGroup({
          ...
          children: [
            ...
            ui.button({
              className: 'dropdown-toggle',
              contents: '<span class="fa fa-caret-down"/>',
      ...
      context.addButton('paragraph', function () {
        return ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: '<i class="fa fa-align-left"/> <span class="fa fa-caret-down"/>',
      ...
      context.addButton('height', function () {
        return ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: '<i class="fa fa-text-height"/> <span class="fa fa-caret-down"/>',
      ...
      context.addButton('table', function () {
        return ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: '<i class="fa fa-table"/> <span class="fa fa-caret-down"/>',
    ...
    this.updateCurrentStyle = function () {
      ...
      if (styleInfo['font-family']) {
        ...
        $toolbar.find('.dropdown-fontname .note-dropdown-item a').each(function () {
      ...
      if (styleInfo['font-size']) {
        ...
        $toolbar.find('.dropdown-fontsize .note-dropdown-item a').each(function () {
      ...
      if (styleInfo['line-height']) {
        ...
        $toolbar.find('.dropdown-line-height .note-dropdown-item a').each(function () {
          // always compare with string to avoid creating another func.
